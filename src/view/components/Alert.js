...
import { changeAlert } from '../../store/ducks/alert';
...
export default function Notify() {    
    ...
    //useSelector pega todos os estados da aplicað§ð£o, todosos reducers
    const alert = useSelector(state => state.alertDuck)    
